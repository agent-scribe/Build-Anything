...
export const metadata: Metadata = {
  title: "Features",
  description:
    "AI generation, a visual editor, 22 section types, 10,000+ templates, built-in e-commerce, and clean code export — everything you need to ship a high-converting site.",
};
...
const SECTIONS = [
  ...
  {
    title: "10,000+ Starter Templates",
    ...
    icon: LayoutGrid,
    items: [
      "4,301 e-commerce store templates",
      "5,700 website templates",
